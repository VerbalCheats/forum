...
$config['database']['database'] = 'epiz_31480248_mybb';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'sql307.epizy.com';
$config['database']['username'] = 'epiz_31480248';
$config['database']['password'] = 'O2BsgpcsDCKyNlc';
