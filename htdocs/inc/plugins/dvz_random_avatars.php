<?php
/* by Tomasz 'Devilshakerz' Mlynski [devilshakerz.com]; Copyright (C) 2015-2021
...
class dvz_ra
{
    ...
    // hooks
    static function user_insert (UserDataHandler $UserDataHandler)
    {
    ...
    static function update_avatar_admin ()
    {
        global $mybb, $db, $user;
    ...
    // core
    static function generate_avatar ()
    {
        global $mybb;
